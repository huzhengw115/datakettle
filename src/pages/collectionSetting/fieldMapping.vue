...
export default {
  ...
  methods: {
    ...
    //       dataObj.inputFields = res.data.inputFields
    //       this.$set(this.$data.requestData, index, dataObj)
    //     })
    //     api.getOutputFields()
    //     .then(res => {
    //       let dataObj = this.requestData[index]
    //       dataObj.outputFields = res.data.outputFields
    //       this.$set(this.$data.requestData, index, dataObj)
    //     })
    //   }
    // },
    ...
    replaceForm (index) {
      if (this.requestData[index].inputFields === undefined) {
        console.log('base: ', this.baseParams.in, 'name: ', this.requestData[index].input)
        ...
        api.getOutputFields(this.baseParams.out, this.requestData[index].output)
        .then(res => {
          let dataObj = this.requestData[index]
