...
export default {
  ...
  methods: {
    ...
    lalala () {
      let baseParams = this.$store.state.collectionSetting.baseParams
      let finishData = this.$store.state.collectionSetting.mappingsData.finishData
      let mappings = this.$store.state.collectionSetting.mappingsParams
