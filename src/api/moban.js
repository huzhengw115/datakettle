...
const instance = Axios.create({
  baseURL: 'http://localhost:8080/', // 18080
  timeout: 10000,
  headers: {
...
export default {
  ...
  getInputForms (params) {
    return instance.get('./static/CSIndex/inputFormsName.json', {params: params})
  },
  // output表名获取
  getOutputForms (params) {
    return instance.get('./static/CSIndex/outputFormsName.json', {params: params})
  },
  // input字段获取
  getInputFields (params) {
    return instance.get('./static/CSIndex/inputFields.json', {params: params})
  },
  // output字段获取
  getOutputFields (params) {
    return instance.get('./static/CSIndex/outputFields.json', {params: params})
  },
  // 生成配置文件
  submitPost (params) {
  ...
  getDirectList (params) {
    return instance.get('./static/directory/index.json', {params: params})
  },
  // 获取目录列表搜索
  getDirectSearch (params) {
    return instance.get('./static/directory/search.json', {params: params})
  },
  // 获取目录列表详情页面
  getDirectDetail (params) {
    return instance.get('./static/directory/detail.json', {params: params})
  },
  // 获取目录列表详情页面搜索
  getDirectDetailSearch (params) {
    return instance.get('./static/directory/searchDetail.json', {params: params})
  },
  // 获取目录列表详情页面弹出框
